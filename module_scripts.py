	...
	("cf_use_workbench", 
	 [(store_script_param, ":agent_id", 1), # must be valid
		...
		(try_begin),
			...
			(assign, ":loop_end", slot_scene_prop_inventory_begin + 10),
			...
			#betterbow
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 100),
				(try_begin),	
			...
			(else_try),
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 1975),
				(try_begin),
			...
			(else_try),
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 3250),
				(try_begin),
			...
			(else_try),
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 2470),
				(try_begin),
					(is_between, ":weapon", 0,100),
	 ...
	 [(store_script_param, ":attacked_agent_id", 1), # must be valid
		...
		(else_try),
			...
			(try_begin),
				...
				(agent_get_player_id, ":attacker_player_id", ":attacker_agent_id"),
				(player_is_active, ":attacker_player_id"),
				(this_or_next|player_slot_eq, ":attacker_player_id", slot_player_faction_id, "fac_7"),
