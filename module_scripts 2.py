	 ...
	 [(store_script_param, ":sender_player_id", 1),
		...
		(else_try), # section of events received by server from the clients
			...
			(else_try), # GGG:handle player send outlaw rating to server
				...
				#GGG
				(else_try),
					(eq, ":slot_no", slot_player_equip_head),
					(player_get_agent_id, ":agent_id", ":player_id"),
					(agent_is_active, ":agent_id"),
					(agent_is_alive, ":agent_id"),
					(is_between, ":value", all_items_begin, all_items_end),
					(item_get_type, ":item_type", ":value"),
					(eq, ":item_type", itp_type_head_armor),
					(player_set_slot, ":player_id", slot_player_equip_head, ":value"),
	...
	("cf_use_workbench", 
	 [(store_script_param, ":agent_id", 1), # must be valid
		...
		(try_begin),
			...
			(assign, ":loop_end", slot_scene_prop_inventory_begin + 9),
			...
			#bow
				...
				(eq, ":found_linen_cloth_small", 2),
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 12),
				(try_begin),
					(eq, ":weapon", 0),
			...
			#crossbow
			(else_try),
				(eq, ":found_wood_block", 2),
				(eq, ":found_wood_pole_short", 1),
				(eq, ":found_iron_piece", 1),
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 7),
				(try_begin),
					(eq, ":weapon", 0),
			...
			(else_try),
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 49),
				(try_begin),
					(eq, ":weapon", 0),
				...
				(else_try),
					(eq, ":weapon", 25),
					(scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_begin + 0, "itm_sarranid_axe_a"),
				(else_try),
					(eq, ":weapon", 26),
					(scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_begin + 0, "itm_sarranid_axe_b"),
				(else_try),
					(eq, ":weapon", 27),
					(scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_begin + 0, "itm_sarranid_two_handed_axe_a"),
				(else_try),
					(eq, ":weapon", 28),
					(scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_begin + 0, "itm_sarranid_two_handed_axe_b"),
				(else_try),
					(eq, ":weapon", 29),
					(scene_prop_set_slot, ":instance_id", slot_scene_prop_inventory_begin + 0, "itm_iron_staff"),
				(else_try),
					(eq, ":weapon", 30),
			...
			(else_try),
				...
				(eq, ":found_linen_cloth_small", 1),
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 34),
				(try_begin),
					(eq, ":weapon", 0),
			...
			(else_try),
				...
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 44),
				(try_begin),
					(eq, ":weapon", 0),
			...
			#armor
			(else_try),
				(eq, ":found_iron_bar_long", 3),
				(eq, ":found_linen_cloth_small", 4),
				(eq, ":found_leather_piece", 2),
				(assign, ":sucess", 1),
				(store_random_in_range, ":weapon", 0, 39),
				(try_begin),
					(eq, ":weapon", 0),
