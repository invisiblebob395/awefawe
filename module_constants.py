...
slot_player_has_disconnected_ok 	  = 59
slot_player_economy_bonus 		      = 60
slot_player_spawnedonce 			  = 61

#Bank Slots for the Player
slot_player_bank_1 					  = 62
slot_player_bank_2 					  = 63
slot_player_bank_3 					  = 64
slot_player_bank_4 					  = 65
slot_player_bank_5 					  = 66
slot_player_bank_6 					  = 67
slot_player_bank_7 					  = 68
slot_player_bank_8 					  = 69
slot_player_bank_9 					  = 70
slot_player_bank_10 				  = 71
slot_player_last_instance_id		  = 72

###GGG:new slot
slot_player_fight_state 			  = 73
slot_player_spawn_water_amount		  = 74

###GGG:new bank
slot_player_must_enter_amount		  = 75
slot_player_gold_give_back			  = 76
###
slot_player_have_access				  = 77
slot_player_fight_not_good			  = 78
###GGG:skill
slot_player_troop_strength            = 79
slot_player_troop_agility             = 80
slot_player_troop_ironflesh           = 81
slot_player_troop_power_strike        = 82
slot_player_troop_power_draw          = 83
slot_player_troop_power_throw         = 84
slot_player_troop_shield              = 85
slot_player_troop_athletics           = 86
slot_player_troop_riding              = 87
slot_player_troop_engineer            = 88
slot_player_troop_wound_treatment     = 89
slot_player_troop_labouring           = 90
slot_player_troop_looting             = 91
slot_player_troop_sailing             = 92
slot_player_troop_tailoring           = 93
slot_player_troop_herding             = 94
slot_player_troop_one_handed_weapon   = 95
slot_player_troop_two_handed_weapon   = 96
slot_player_troop_polearm             = 97
slot_player_troop_archery             = 98
slot_player_troop_crossbow            = 99
slot_player_troop_throwing            = 100
slot_player_unused_skill_points       = 101
slot_player_used_skill_points         = 102

slot_player_title                     = 103
slot_player_is_prisoner               = 104
slot_player_exiting                   = 105
slot_player_knights                   = 106
##Arthur begins
...
###GGG:new slot
slot_agent_water_amount               = 67
slot_agent_belong_player              = 68
slot_agent_scene_prop_in_use		  = 69
slot_agent_playing_music			  = 70

slot_agent_shieldbash_cooldown        = 71
...
#GGG:get materials
slot_scene_prop_itm_material_1        = 55
slot_scene_prop_itm_material_2        = 56
slot_scene_prop_itm_material_3        = 57
slot_scene_prop_itm_material_4        = 58
...
slot_scene_prop_bank                  = 102
slot_scene_prop_item_chest_in_use     = 103
########################################################
##  ITEM SLOTS             #############################
########################################################
...
#GGG:admin tools
slot_faction_alow_use_capture         = 8
slot_faction_military_strength        = 9 #GGG:troop system
...
slot_troop_hero_is_used               = 52 #GGG:skill menu
...
max_distance_to_see_labels            = 3000
...
outlaw_rating_for_kill                = 5 #GGG:2
outlaw_rating_for_team_kill           = 2 #GGG:5
outlaw_rating_for_lord_outlawed       = 1 #GGG:1
...
scripted_items_begin = "itm_surgeon_scalpel" #ggg:itm_surgeon_scalpel itm_light_lance # items outside this range are not checked from the ti_on_agent_hit trigger
...
#GGG:save area
work_item_begin = "itm_hatchet"
work_item_end = "itm_lyre" #including tools and food
