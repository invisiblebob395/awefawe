...
itp_force_attach_left_hand      = 0
itp_force_attach_right_hand     = 0
itp_force_attach_left_forearm   = 0
itp_attach_armature             = 0
itp_attachment_mask             = 0
...
itp_cant_reload_on_horseback = 0
itp_two_handed               = 0
itp_primary                  = 0 # for weapons
itp_replaces_helm            = 0 # for armor, allows body armor items which include helmet
itp_secondary                = 0 # for weapons
itp_replaces_shoes           = 0 # for armor, allows body armor items which include boots
itp_covers_legs              = 0
itp_doesnt_cover_hair        = 0
itp_can_penetrate_shield     = 0
itp_consumable               = 0
itp_bonus_against_shield     = 0
itp_penalty_with_shield      = 0
itp_cant_use_on_horseback    = 0
itp_civilian                 = 0
itp_next_item_as_melee       = 0
itp_fit_to_head              = 0
itp_offset_lance             = 0
itp_covers_head              = 0
itp_couchable                = 0
...
itp_remove_item_on_use       = 0
itp_unbalanced               = 0

itp_covers_beard             = 0 # remove beard mesh
itp_no_pick_up_from_ground   = 0
itp_can_knock_down           = 0
itp_covers_hair              = 0 # remove hair mesh for armors only

itp_force_show_body          = 0 # forces showing body (works on body armor items)
itp_force_show_left_hand     = 0 # forces showing left hand (works on hand armor items)
itp_force_show_right_hand    = 0 # forces showing right hand (works on hand armor items)

itp_extra_penetration        = 0
itp_has_bayonet              = 0
itp_cant_reload_while_moving = 0
itp_ignore_gravity           = 0
itp_ignore_friction          = 0
itp_is_pike                  = 0
itp_offset_musket            = 0
itp_no_blur                  = 0

itp_cant_reload_while_moving_mounted = 0
itp_has_upper_stab           = 0
itp_kill_info_mask           = 0
itp_kill_info_bits           = 0
