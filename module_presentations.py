...
presentations.extend([
  ...
  ("game_profile_banner_selection", 0, "mesh_load_window", # converted to a profile options selection
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      #ggg:daytime
      (create_text_overlay, "$g_presentation_input_time", "str_time"),
      (position_set_x, pos1, 78),
      (position_set_y, pos1, 347), 
      (overlay_set_position, "$g_presentation_input_time", pos1),

      (create_combo_label_overlay, "$g_presentation_obj_give_time"),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 347),
      (overlay_set_position, "$g_presentation_obj_give_time", pos1),
      (overlay_add_item, "$g_presentation_obj_give_time", "str_default"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@0"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@1"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@2"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@3"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@4"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@5"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@6"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@7"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@8"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@9"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@10"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@11"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@12"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@13"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@14"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@15"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@16"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@17"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@18"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@19"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@20"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@21"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@22"),
      (overlay_add_item, "$g_presentation_obj_give_time", "@23"),
      #
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      #GGG:daytime
      (try_begin),
        (eq, ":object", "$g_presentation_obj_give_time"),
        (assign, "$hours", ":value"),
      (try_end),
      #
      (try_begin),
   ...
   [(ti_on_presentation_load,
    ...
    (ti_on_presentation_run,
     ...
     #GGG:no spectator
      (multiplayer_get_my_player, ":my_player_id"),
      (try_begin),
        (this_or_next|player_is_admin, ":my_player_id"), #
        (neg|is_presentation_active, "prsnt_respawn_time_counter"),
        (key_clicked, key_escape),
        (gt, ":cur_time", 200),
        (presentation_set_duration, 0),
      (try_end),
  ...
  ("escape_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      #GGG:music menu
      (create_button_overlay, reg0, "str_music_menu", 0),
      (assign, "$g_presentation_obj_escape_menu_music", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),

      #GGG:skills menu
      (create_button_overlay, reg0, "str_skills_menu", 0),
      (assign, "$g_presentation_obj_escape_menu_skills", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      #
      ...
      (val_sub, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_escape_menu_music", pos1),

      #GGG:skills menu
      (val_sub, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_escape_menu_skills", pos1),
      #
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      #GGG:music menu
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_music"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_music_menu"),
      #GGG:skills menu
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_skills"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_skills_menu"),
      #
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_quit"),
        (display_message, "@Requesting disconnect.. IMPORTANT: DO NOT FORCE QUIT", 0xFFFF22),
        (multiplayer_send_message_to_server, client_event_player_request_exit),
        (presentation_set_duration, 0),
        ##(finish_mission, 0), #dont end just yet..
      (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        #GGG:admin tools
        (this_or_next|eq, "$g_list_players_event_value", admin_action_add_outlaw_player),
        (this_or_next|eq, "$g_list_players_event_value", admin_action_sub_outlaw_player),
        #
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":faction_id", castle_factions_begin, factions_end),
        ...
        (try_begin),
        #GGG:lock capture
          (eq, "$g_list_factions_event_value", admin_action_lock_faction_capture),
        (else_try),
        #
          (eq, "$g_list_factions_event_value", admin_action_lock_faction),
        (else_try),
        #
      ...
      (try_for_range, ":faction_id", castle_factions_begin, factions_end),
        ...
        (try_begin),
          ...
          (try_begin),
            (neg|faction_slot_ge, ":faction_id", slot_faction_alow_use_capture, 1),
            (str_store_string, s1, "str_unlock_capture"),
          (else_try),
            (faction_slot_ge, ":faction_id", slot_faction_alow_use_capture, 1),
            (str_store_string, s1, "str_lock_capture"),
          (try_end),
        ...
        (else_try),
          ...
          (str_store_faction_name, s0, ":faction_id"),
          (try_begin),
            (neg|faction_slot_ge, ":faction_id", slot_faction_is_locked, 1),
            (str_store_string, s1, "str_unlock_capture"),
          (else_try),
            (faction_slot_ge, ":faction_id", slot_faction_is_locked, 1),
            (str_store_string, s1, "str_lock_capture"),
          (try_end),
          (create_button_overlay, reg1, s1),
        (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (try_for_range, ":faction_id", castle_factions_begin, ":loop_end"),
        ...
        #GGG:lock capture
          (eq, "$g_list_factions_event_value", admin_action_lock_faction_capture),
          (multiplayer_send_2_int_to_server, client_event_admin_faction_action, admin_action_lock_faction_capture, ":faction_id"),
        (else_try),
        #GGG:lock faction
          (eq, "$g_list_factions_event_value", admin_action_lock_faction),
          (multiplayer_send_2_int_to_server, client_event_admin_faction_action, admin_action_lock_faction, ":faction_id"),
        (else_try),
        #
  ...
  ("admin_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_factions, 0),
        (create_button_overlay, reg0, "str_lock_faction_capture"),
        (assign, "$g_presentation_obj_admin_menu_lock_faction_capture", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_lock_faction_capture", -1),
      (try_end),
      #
      ...
      (try_begin),
        ...
        #GGG:admin tools
        (create_button_overlay, reg0, "str_reset_carts"),
        (assign, "$g_presentation_obj_admin_menu_reset_carts", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (else_try),
        ...
        (assign, "$g_presentation_obj_admin_menu_reset_carts", -1), #GGG:admin tools
      (try_end),

      (try_begin),
        #GGG:admin tools
        (player_slot_eq, ":my_player_id", slot_player_admin_no_animals, 0),
        (create_button_overlay, reg0, "str_remove_wild_animals"),
        (assign, "$g_presentation_obj_admin_menu_remove_wild_animals", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (create_button_overlay, reg0, "str_remove_corpses"),
        (assign, "$g_presentation_obj_admin_menu_remove_corpses", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (create_button_overlay, reg0, "str_remove_all_weapons"),
        (assign, "$g_presentation_obj_admin_menu_remove_all_weapons", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (else_try),
        #GGG:admin tools
        (assign, "$g_presentation_obj_admin_menu_remove_wild_animals", -1),
        (assign, "$g_presentation_obj_admin_menu_remove_corpses", -1),
        (assign, "$g_presentation_obj_admin_menu_remove_all_weapons", -1),
        #
      ...
      (try_begin),
        ...
        #GGG:admin tools
        (create_button_overlay, reg0, "str_teleport_player_to_admin"),
        (assign, "$g_presentation_obj_admin_menu_teleport_player_to_admin", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_teleport_player_to_admin", -1), #GGG:admin tools
      ...
      ###GGG:admin tools
        ...
        (create_button_overlay, reg0, "str_sub_outlaw_player"),
        (assign, "$g_presentation_obj_admin_menu_sub_outlaw_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (player_slot_eq, ":my_player_id", slot_player_admin_no_freeze, 0),
        (create_button_overlay, reg0, "str_add_outlaw_player"),
        (assign, "$g_presentation_obj_admin_menu_add_outlaw_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (else_try),
      #GGG:admin tools
        (assign, "$g_presentation_obj_admin_menu_sub_outlaw_player", -1),
        (assign, "$g_presentation_obj_admin_menu_add_outlaw_player", -1),
        #
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      #GGG:admin tools
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_add_outlaw_player"),
        (assign, ":action", admin_action_add_outlaw_player),
        (assign, "$g_list_players_action_string_id", "str_add_outlaw_player"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_sub_outlaw_player"),
        (assign, ":action", admin_action_sub_outlaw_player),
        (assign, "$g_list_players_action_string_id", "str_sub_outlaw_player"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_teleport_player_to_admin"),
        (assign, ":action", admin_action_teleport_player_to_admin),
        (assign, "$g_list_players_action_string_id", "str_teleport_player_to_admin"),
      #
      (else_try),
      ...
      #GGG:admin tools
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_remove_wild_animals"),
        (multiplayer_send_int_to_server, client_event_admin_action, admin_action_remove_wild_animals),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_remove_corpses"),
        (multiplayer_send_int_to_server, client_event_admin_action, admin_action_remove_corpses),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_remove_all_weapons"),
        (multiplayer_send_int_to_server, client_event_admin_action, admin_action_remove_all_weapons),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_reset_carts"),
        (multiplayer_send_int_to_server, client_event_admin_action, admin_action_reset_carts),
      #
      (else_try),
      ...
      (else_try),
        (try_begin),
          ...
          (assign, "$g_list_factions_event_value", admin_action_lock_faction),
      #GGG:lock capture
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_menu_lock_faction_capture"),
          (assign, "$g_list_factions_event_value", admin_action_lock_faction_capture),
        (try_end),
        (presentation_set_duration, 0),
        (assign, "$g_list_factions_event", client_event_admin_action),
        (assign, "$g_list_factions_return_presentation", "prsnt_admin_menu"),
  ...
  ##death blocker: arthur prevent spectating
  ("death_blocker", prsntf_manual_end_only, 0, [
  (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
      ]),
  ...
  ("respawn_time_counter", prsntf_manual_end_only, 0, # show seconds until respawn and allow requesting the next spawn point
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_military_strength", -1), #GGG:troop system
      ...
      (try_begin), #arthur omit keys
        ...
        (omit_key_once, gk_equip_primary_weapon),
        (omit_key_once, gk_equip_secondary_weapon),
        (omit_key_once, key_i),
      (try_end),
      (presentation_set_duration, 999999),
      ]),
    (ti_on_presentation_run,
     ...
     (try_begin), #arthur omit keys
      ...
      (else_try),
        ...
        (omit_key_once, gk_defend),
      (else_try),
        (game_key_is_down, gk_equip_primary_weapon),
        (omit_key_once, gk_equip_primary_weapon),
      (else_try),
        (game_key_is_down, gk_equip_secondary_weapon),
        (omit_key_once, gk_equip_secondary_weapon),
      (else_try),
        (key_is_down, key_i),
        (omit_key_once, key_i),
        ...
        (else_try),
          ...
          (try_begin), # check for valid castles to spawn at, displaying the next if that control is pressed
            ...
            (try_begin),
              (eq, ":loop_end", -1),
              (try_begin),
                (le, "$g_presentation_obj_military_strength", -1),
                (faction_get_slot, ":strength", ":faction_id", slot_faction_military_strength),
                (assign, reg3, ":strength"),
                (create_text_overlay, "$g_presentation_obj_military_strength", "str_faction_military_strength_is_reg1", tf_center_justify|tf_with_outline),
                (overlay_set_color, "$g_presentation_obj_military_strength", 0xFFFFFF),
                (position_set_x, pos1, 500),
                (position_set_y, pos1, 500),
                (overlay_set_position, "$g_presentation_obj_military_strength", pos1),
                (position_set_x, pos1, 1400),
                (position_set_y, pos1, 1400),
                (overlay_set_size, "$g_presentation_obj_military_strength", pos1),
              (else_try),
                (overlay_set_text, "$g_presentation_obj_military_strength", "str_faction_military_strength_is_reg1"),
                (overlay_set_display, "$g_presentation_obj_military_strength", 1), 
              (try_end),
            (try_end),
            #
          (try_end),
          (try_begin),
            ...
            (overlay_set_display, "$g_presentation_obj_military_strength", 0), #GGG:troop system
          (try_end),
  ...
  ("tabbed_stats_chart", prsntf_manual_end_only, 0, # displays tab buttons marked with faction symbols to view lists of members and their stats
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      #GGG:new
      (store_add, ":knights_x", ":start_x", 350), 
      (position_set_x, pos2, ":knights_x"),
      (store_add, ":title_x", ":start_x", 400), #430 
      (position_set_x, pos3, ":title_x"),
      (store_add, ":class_x", ":start_x", 480), 
      (position_set_x, pos4, ":class_x"),
      #
      (store_add, ":outlaw_x", ":start_x", 540), 
      (position_set_x, pos5, ":outlaw_x"),
      (store_add, ":kills_x", ":start_x", 600), 
      (position_set_x, pos6, ":kills_x"),
      (store_add, ":deaths_x", ":start_x", 655), 
      (position_set_x, pos7, ":deaths_x"),
      (store_add, ":ping_x", ":start_x", 710), 
      (position_set_x, pos8, ":ping_x"),
      (position_set_y, pos1, ":cur_y"),
      ...
      #GGG:new
      (position_set_y, pos6, ":cur_y"),
      (position_set_y, pos7, ":cur_y"),
      (position_set_y, pos8, ":cur_y"),
      #
      ...
      #GGG:knights
      (create_text_overlay, reg1, "str_knights", tf_center_justify),
      (overlay_set_color, reg1, 0xFFFFFF),
      (overlay_set_position, reg1, pos2),
      (overlay_set_size, reg1, pos11),

      #GGG:title
      (create_text_overlay, reg1, "str_title", tf_center_justify),
      (overlay_set_color, reg1, 0xFFFFFF),
      ...
      ###GGG:admin tools
        (player_is_admin, ":my_player_id"),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_announce, 0),
        (ge, ":faction_id", factions_begin),
      ...
      #  (player_slot_eq, ":my_player_id", slot_player_admin_no_announce, 0),
      #  (ge, ":faction_id", factions_begin),
      #  (create_text_overlay, reg1, "str_outlaw_rating", tf_center_justify),
      #  (overlay_set_color, reg1, 0xFFFFFF),
      #  (overlay_set_position, reg1, pos3),
      #  (overlay_set_size, reg1, pos11),
      #(else_try),
      ...
      (overlay_set_color, reg1, 0xFFFFFF),
      (overlay_set_position, reg1, pos7), 
      (overlay_set_size, reg1, pos11),

      (create_text_overlay, reg1, "str_ping", tf_center_justify),
      (overlay_set_color, reg1, 0xFFFFFF),
      (overlay_set_position, reg1, pos8), 
      (overlay_set_size, reg1, pos11),
      ...
      (try_end),
      (try_for_range, ":position_no", 3, 9), #GGG
        (position_get_x, ":temp_x", ":position_no"),
        (val_sub, ":temp_x", 91),
        (position_set_x, ":position_no", ":temp_x"),
      (try_end),
      ...
      (try_for_range_backwards, ":player_index", 0, ":player_count"),
        ...
        #GGG:knights
        (player_get_slot, ":player_knights", ":player_id", slot_player_knights),
        (try_begin),
          (eq, ":player_knights", 1),
          (str_store_string, s1, "str_knights_1"),
        (else_try),
        ...
        #GGG:title
        (player_get_slot, ":title_number", ":player_id", slot_player_title),
        (try_begin),
          (eq, ":title_number", 1),
          (str_store_string, s1, "str_baron"),
        (else_try),
          (eq, ":title_number", 2),
          (str_store_string, s1, "str_viscount"),
        (else_try),
          (eq, ":title_number", 3),
          (str_store_string, s1, "str_count"),
        (else_try),
          (eq, ":title_number", 4),
          (str_store_string, s1, "str_marquis"),
        (else_try),
          (eq, ":title_number", 5),
          (str_store_string, s1, "str_duke"),
        (else_try),
          (eq, ":title_number", 6),
          (str_store_string, s1, "str_knight_master"),
        (else_try),
          (eq, ":title_number", 7),
          (str_store_string, s1, "str_iron_bank"),
        (else_try),
          (eq, ":title_number", 8),
          (str_store_string, s1, "str_protector_of_the_realm"),
        (else_try),
          (eq, ":title_number", 9),
          (str_store_string, s1, "str_king_of_eight_kingdom"),
        (else_try),
          (eq, ":title_number", 10),
          (str_store_string, s1, "str_city_guard"),
        (else_try),
          (eq, ":title_number", 11),
          (str_store_string, s1, "str_boss_of_bar"),
        (else_try),
          (eq, ":title_number", 12),
          (str_store_string, s1, "str_minstrel"),
        (else_try),
          (eq, ":title_number", 13),
          (str_store_string, s1, "str_grand_scholar"),
        (else_try),
          (eq, ":title_number", 14),
          (str_store_string, s1, "str_archbishop"),
        (else_try),
          (eq, ":title_number", 15),
          (str_store_string, s1, "str_banker"),
        (else_try),
          (eq, ":title_number", 16),
          (str_store_string, s1, "str_capitalist"),
        (else_try),
          (eq, ":title_number", 17),
          (str_store_string, s1, "str_weapons_master"),
        (else_try),
          (eq, ":title_number", 18),
          (str_store_string, s1, "str_armour_master"),
        (else_try),
          (eq, ":title_number", 19),
          (str_store_string, s1, "str_golden_regiment"),
        (else_try),
          (eq, ":title_number", 20),
          (str_store_string, s1, "str_second_sons"),
        (else_try),
          (eq, ":title_number", 21),
          (str_store_string, s1, "str_sword_of_morning"),
        (else_try),
          (eq, ":title_number", 22),
          (str_store_string, s1, "str_horse_king"),
        (else_try),
          (eq, ":title_number", 23),
          (str_store_string, s1, "str_no_banners_man"),
        (else_try),
          (eq, ":title_number", 24),
          (str_store_string, s1, "str_hand_of_king"),
        (else_try),
          (eq, ":title_number", 25),
          (str_store_string, s1, "str_green_prophet"),
        (else_try),
          (eq, ":title_number", 26),
          (player_get_slot, ":outlaw_rating", ":player_id", slot_player_outlaw_rating),
          (ge, ":outlaw_rating", 15),
          (str_store_string, s1, "str_hound"),
        (else_try),
          (eq, ":title_number", 27),
          (player_get_slot, ":outlaw_rating", ":player_id", slot_player_outlaw_rating),
          (eq, ":outlaw_rating", 30),
          (str_store_string, s1, "str_mountain"),
        (else_try),
          (eq, ":title_number", 28),
          (str_store_string, s1, "str_family_leader"),
        (else_try),
          (eq, ":title_number", 29),
          (str_store_string, s1, "str_kingsguard"),
        (else_try),
          (eq, ":title_number", 30),
          (str_store_string, s1, "str_khal"),
        (else_try),
          (eq, ":title_number", 31),
          (str_store_string, s1, "str_greenwood_man"),
        (else_try),
          (eq, ":title_number", 32),
          (str_store_string, s1, "str_rainbow_tailor"),
        (else_try),
          (eq, ":title_number", 33),
          (str_store_string, s1, "str_breaker_of_chains"),
        (else_try),
          (eq, ":title_number", 34),
          (str_store_string, s1, "str_knight_of_flowers"),
        (else_try),
          (eq, ":title_number", 35),
          (str_store_string, s1, "str_kingslayer"),
        (else_try),
          (eq, ":title_number", 36),
          (str_store_string, s1, "str_red_serpent"),
        (else_try),
          (eq, ":title_number", 37),
          (str_store_string, s1, "str_no_one"),
        (else_try),
          (str_store_string, s1, "str_empty_string"),
        (try_end),
        (create_text_overlay, reg1, s1, tf_center_justify),
        ...
        #  (player_slot_eq, ":my_player_id", slot_player_admin_no_announce, 0),
        #  (is_between, ":faction_id", factions_begin, factions_end),
        #  (player_get_slot, reg0, ":player_id", slot_player_outlaw_rating),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      (try_begin),
        ...
        #(omit_key_once, gk_game_log_window),
        (presentation_set_duration, 999999),
      #(else_try),
      #  (presentation_set_duration, 0),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [#(clear_omitted_keys),
      ...
      (multiplayer_get_my_player, ":my_player_id"),
      (player_get_team_no, ":my_team", ":my_player_id"),
      (this_or_next|eq, ":my_team", team_spectators), 
      (eq, "$g_player_has_spawned_after_connecting", 1),
      #
      (multiplayer_send_message_to_server, client_event_request_spawn_point),
      (assign, "$g_player_has_spawned_after_connecting", 1),
      #(presentation_set_duration, 0),
    ...
    (ti_on_presentation_run,
     ...
     #GGG:no spectator
      ...
      (player_get_team_no, ":my_team", ":my_player_id"),     
      (try_begin),
        (this_or_next|neq, ":my_team", team_spectators),
        (player_is_admin, ":my_player_id"), #
        #(key_clicked, key_escape),
        (gt, ":cur_time", 200),
        #(clear_omitted_keys),
   ...
   [(ti_on_presentation_load,
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      #GGG:open helmet
      (else_try),
        (eq, ":string_id", "str_toggle_helmet"),
        (try_begin),
          (multiplayer_get_my_player, ":player_id"),
          (player_get_agent_id, ":agent_id", ":player_id"), 
          (agent_get_item_slot, ":item_needed", ":agent_id", 4),
          (gt, ":item_needed", 0),
          (try_begin),
            (eq, ":item_needed", "itm_huntdog_helmet"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_huntdog_helmet_open"),
          (else_try),
            (eq, ":item_needed", "itm_huntdog_helmet_open"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_huntdog_helmet"),

          (else_try),
            (eq, ":item_needed", "itm_great_helmet_skin30"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_great_helmet_skin30_open"),
          (else_try),
            (eq, ":item_needed", "itm_great_helmet_skin30_open"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_great_helmet_skin30"),

          (else_try),
            (eq, ":item_needed", "itm_great_helmet_skin31"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_great_helmet_skin31_open"),
          (else_try),
            (eq, ":item_needed", "itm_great_helmet_skin31_open"),
            (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":player_id", slot_player_equip_head, "itm_great_helmet_skin31"),
          (try_end),
        (try_end),
      #
      (else_try),
      ...
      #GGG:skills menu
      #(else_try),
      #  (eq, ":string_id", "str_buy_skill_point"),
      #  (multiplayer_get_my_player, ":my_player_id"),
      #  (player_is_active, ":my_player_id"),
      #  (player_get_gold, ":gold", ":my_player_id"),
      #  (player_get_troop_id, ":my_troop_id", ":my_player_id"),
      #  (player_get_slot, ":player_used_skill_points", ":my_player_id", slot_player_used_skill_points),
      #  (player_get_slot, ":player_unused_skill_points", ":my_player_id", slot_player_unused_skill_points),
      #  (try_begin),
      #    (is_between, ":my_troop_id", hero_begin, hero_end),
      #    (ge, ":gold", 100000),
      #    (lt, ":player_used_skill_points", 45),
      #    (call_script, "script_player_adjust_gold", ":my_player_id", 100000, -1),
      #    (val_add, ":player_used_skill_points", 1),
      #    (player_set_slot, ":my_player_id", slot_player_used_skill_points, ":player_used_skill_points"),
      #    (val_add, ":player_unused_skill_points", 1),
      #    (player_set_slot, ":my_player_id", slot_player_unused_skill_points, ":player_unused_skill_points"),
      #  (try_end),
      #(else_try),
      #  (eq, ":string_id", "str_reset_skill_point"),
      #  (multiplayer_get_my_player, ":my_player_id"),
      #  (player_is_active, ":my_player_id"),
      #  (player_get_gold, ":gold", ":my_player_id"),
      #  (player_get_troop_id, ":my_troop_id", ":my_player_id"),
      ...
      #    (ge, ":gold", 450000),
      #    (is_between, ":my_troop_id", hero_begin, hero_end),
      #    (le, ":player_used_skill_points", 45),
      #    (call_script, "script_player_adjust_gold", ":my_player_id", 450000, -1),
      #    (assign, ":player_unused_skill_points", ":player_used_skill_points"),
      #    (player_set_slot, ":my_player_id", slot_player_unused_skill_points, ":player_unused_skill_points"),

      #    (troop_raise_attribute, ":my_troop_id", ca_strength, -20),
      #    (troop_raise_attribute, ":my_troop_id", ca_agility, -20),
      #    (troop_raise_skill, ":my_troop_id", skl_ironflesh, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_power_strike, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_power_draw, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_power_throw, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_shield, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_riding, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_engineer, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_wound_treatment, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_labouring, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_looting, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_sailing, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_tailoring, -10),
      #    (troop_raise_skill, ":my_troop_id", skl_herding, -10),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_one_handed_weapon, -200),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_two_handed_weapon, -200),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_polearm, -200),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_archery, -200),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_crossbow, -200),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_throwing, -200),

      #    (troop_raise_attribute, ":my_troop_id", ca_strength, 8),
      #    (troop_raise_attribute, ":my_troop_id", ca_agility, 8),
      #    (troop_raise_skill, ":my_troop_id", skl_power_strike, 1),
      #    (troop_raise_skill, ":my_troop_id", skl_labouring, 2),
      #    (troop_raise_skill, ":my_troop_id", skl_tailoring, 1),
      #    (troop_raise_skill, ":my_troop_id", skl_riding, 1),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_one_handed_weapon, 40),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_two_handed_weapon, 20),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_polearm, 20),
      #    (troop_raise_proficiency_linear, ":my_troop_id", wpt_throwing, 20),
      #  (try_end),
      #
      (try_end),
      (try_begin),
...
###GGG:thirst system
  ("water_bar", prsntf_read_only|prsntf_manual_end_only, 0, 
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 10000),

      (create_mesh_overlay, "$g_presentation_obj_water_bar", "mesh_pw_status_food_bar"),
      (position_set_x, pos1, 8603),
      (position_set_y, pos1, 761), #561

      (overlay_set_position, "$g_presentation_obj_water_bar", pos1),
      (overlay_set_display, "$g_presentation_obj_water_bar", 0),
      (assign, "$g_presentation_water_bar_current_amount", -1),

      (create_mesh_overlay, "$g_presentation_obj_water_bar_background", "mesh_pw_status_background_player"),
      (overlay_set_position, "$g_presentation_obj_water_bar_background", pos1),
      (overlay_set_display, "$g_presentation_obj_water_bar_background", 0),
    ...
    (ti_on_presentation_run,
     [(set_fixed_point_multiplier, max_food_amount),
      ...
      (try_begin),
        ...
        (try_begin),
          (neq, "$g_presentation_water_bar_current_amount", ":water_amount"),
          (assign, "$g_presentation_water_bar_current_amount", ":water_amount"),
          (val_max, ":water_amount", 1),
          (position_set_x, pos1, ":water_amount"),
          (position_set_y, pos1, max_food_amount),
          (overlay_set_size, "$g_presentation_obj_water_bar", pos1),
          (overlay_set_display, "$g_presentation_obj_water_bar", 1),
          (overlay_set_display, "$g_presentation_obj_water_bar_background", 1),
        (try_end),
      (else_try),
        (gt, "$g_presentation_water_bar_current_amount", -1),
        (assign, "$g_presentation_water_bar_current_amount", -1),
        (overlay_set_display, "$g_presentation_obj_water_bar", 0),
        (overlay_set_display, "$g_presentation_obj_water_bar_background", 0),
      (try_end),
...
#
  ...
  #GGG:music menu
  ("music_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (position_set_y, pos2, 900),
      (assign, ":cur_y", 10),
      (position_set_x, pos1, 60), #130

      (create_button_overlay, reg0, "str_bgm_warrior"),
      (assign, "$g_presentation_obj_music_object_6", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_bgm_ezio"),
      (assign, "$g_presentation_obj_music_object_5", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_bgm_away"),
      (assign, "$g_presentation_obj_music_object_4", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_bgm_lankhmar"),
      (assign, "$g_presentation_obj_music_object_3", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_bgm_world"),
      (assign, "$g_presentation_obj_music_object_2", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_bgm_victory"),
      (assign, "$g_presentation_obj_music_object_1", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_music_object_1"),
        (play_track, "track_bgm_victory", 2),
      (else_try),
        (eq, ":object", "$g_presentation_obj_music_object_2"),
        (play_track, "track_bgm_world", 2),
      (else_try),
        (eq, ":object", "$g_presentation_obj_music_object_3"),
        (play_track, "track_bgm_lankhmar", 2),
      (else_try),
        (eq, ":object", "$g_presentation_obj_music_object_4"),
        (play_track, "track_bgm_away", 2),
      (else_try),
        (eq, ":object", "$g_presentation_obj_music_object_5"),
        (play_track, "track_bgm_ezio", 2),
      (else_try),
        (eq, ":object", "$g_presentation_obj_music_object_6"),
        (play_track, "track_bgm_warrior", 2),
      (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
  ...
  #GGG:skills menu
  ("skills_menu", prsntf_manual_end_only, 0, 
    [(ti_on_presentation_load, 
      [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (troop_raise_skill, ":my_troop_id", skl_power_throw, -10),
        (troop_raise_skill, ":my_troop_id", skl_shield, -10),
        (troop_raise_skill, ":my_troop_id", skl_athletics, -10),
        (troop_raise_skill, ":my_troop_id", skl_riding, -10),
        (troop_raise_skill, ":my_troop_id", skl_engineer, -10),
        (troop_raise_skill, ":my_troop_id", skl_wound_treatment, -10),
        (troop_raise_skill, ":my_troop_id", skl_labouring, -10),
        ...
        (player_get_slot, "$player_strength", ":my_player_id", slot_player_troop_strength),
        (player_get_slot, "$player_agility", ":my_player_id", slot_player_troop_agility),
        (player_get_slot, "$player_ironflesh", ":my_player_id", slot_player_troop_ironflesh),
        (player_get_slot, "$player_power_strike", ":my_player_id", slot_player_troop_power_strike),
        (player_get_slot, "$player_power_draw", ":my_player_id", slot_player_troop_power_draw),
        (player_get_slot, "$player_power_throw", ":my_player_id", slot_player_troop_power_throw),
        (player_get_slot, "$player_shield", ":my_player_id", slot_player_troop_shield),
        (player_get_slot, "$player_athletics", ":my_player_id", slot_player_troop_athletics),
        (player_get_slot, "$player_riding", ":my_player_id", slot_player_troop_riding),
        (player_get_slot, "$player_engineer", ":my_player_id", slot_player_troop_engineer),
        (player_get_slot, "$player_wound_treatment", ":my_player_id", slot_player_troop_wound_treatment),
        (player_get_slot, "$player_labouring", ":my_player_id", slot_player_troop_labouring),
        (player_get_slot, "$player_looting", ":my_player_id", slot_player_troop_looting),
        (player_get_slot, "$player_sailing", ":my_player_id", slot_player_troop_sailing),
        (player_get_slot, "$player_tailoring", ":my_player_id", slot_player_troop_tailoring),
        (player_get_slot, "$player_herding", ":my_player_id", slot_player_troop_herding),
        (player_get_slot, "$player_one_handed", ":my_player_id", slot_player_troop_one_handed_weapon),
        (player_get_slot, "$player_two_handed", ":my_player_id", slot_player_troop_two_handed_weapon),
        (player_get_slot, "$player_polearm", ":my_player_id", slot_player_troop_polearm),
        (player_get_slot, "$player_archery", ":my_player_id", slot_player_troop_archery),
        (player_get_slot, "$player_crossbow", ":my_player_id", slot_player_troop_crossbow),
        (player_get_slot, "$player_throwing", ":my_player_id", slot_player_troop_throwing),
        (player_get_slot, "$player_skill_point", ":my_player_id", slot_player_unused_skill_points),

        (troop_raise_attribute, ":my_troop_id", ca_strength, "$player_strength"),
        (troop_raise_attribute, ":my_troop_id", ca_agility, "$player_agility"),
        (troop_raise_skill, ":my_troop_id", skl_ironflesh, "$player_ironflesh"),
        (troop_raise_skill, ":my_troop_id", skl_power_strike, "$player_power_strike"),
        (troop_raise_skill, ":my_troop_id", skl_power_draw, "$player_power_draw"),
        (troop_raise_skill, ":my_troop_id", skl_power_throw, "$player_power_throw"),
        (troop_raise_skill, ":my_troop_id", skl_shield, "$player_shield"),
        (troop_raise_skill, ":my_troop_id", skl_athletics, "$player_athletics"),
        (troop_raise_skill, ":my_troop_id", skl_riding, "$player_riding"),
        (troop_raise_skill, ":my_troop_id", skl_engineer, "$player_engineer"),
        (troop_raise_skill, ":my_troop_id", skl_wound_treatment, "$player_wound_treatment"),
        (troop_raise_skill, ":my_troop_id", skl_labouring, "$player_labouring"),
        (troop_raise_skill, ":my_troop_id", skl_looting, "$player_looting"),
        (troop_raise_skill, ":my_troop_id", skl_sailing, "$player_sailing"),
        (troop_raise_skill, ":my_troop_id", skl_tailoring, "$player_tailoring"),
        (troop_raise_skill, ":my_troop_id", skl_herding, "$player_herding"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_one_handed_weapon, "$player_one_handed"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_two_handed_weapon, "$player_two_handed"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_polearm, "$player_polearm"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_archery, "$player_archery"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_crossbow, "$player_crossbow"),
        (troop_raise_proficiency_linear, ":my_troop_id", wpt_throwing, "$player_throwing"),
      (else_try),
        (store_attribute_level, "$player_strength", ":my_troop_id", ca_strength),
        (store_attribute_level, "$player_agility", ":my_troop_id", ca_agility),
        (store_skill_level, "$player_ironflesh", skl_ironflesh, ":my_troop_id"),
        (store_skill_level, "$player_power_strike", skl_power_strike, ":my_troop_id"),
        (store_skill_level, "$player_power_draw", skl_power_draw, ":my_troop_id"),
        (store_skill_level, "$player_power_throw", skl_power_throw, ":my_troop_id"),
        (store_skill_level, "$player_shield", skl_shield, ":my_troop_id"),
        (store_skill_level, "$player_athletics", skl_athletics, ":my_troop_id"),
        (store_skill_level, "$player_riding", skl_riding, ":my_troop_id"),
        (store_skill_level, "$player_engineer", skl_engineer, ":my_troop_id"),
        (store_skill_level, "$player_wound_treatment", skl_wound_treatment, ":my_troop_id"),
        (store_skill_level, "$player_labouring", skl_labouring, ":my_troop_id"),
        (store_skill_level, "$player_looting", skl_looting, ":my_troop_id"),
        (store_skill_level, "$player_sailing", skl_sailing, ":my_troop_id"),
        (store_skill_level, "$player_tailoring", skl_tailoring, ":my_troop_id"),
        (store_skill_level, "$player_herding", skl_herding, ":my_troop_id"),
        (store_proficiency_level, "$player_one_handed", ":my_troop_id", wpt_one_handed_weapon),
        (store_proficiency_level, "$player_two_handed", ":my_troop_id", wpt_two_handed_weapon),
        (store_proficiency_level, "$player_polearm", ":my_troop_id", wpt_polearm),
        (store_proficiency_level, "$player_archery", ":my_troop_id", wpt_archery),
        (store_proficiency_level, "$player_crossbow", ":my_troop_id", wpt_crossbow),
        (store_proficiency_level, "$player_throwing", ":my_troop_id", wpt_throwing), 
      (try_end),

      (create_button_overlay, reg0, "str_sure", 0),
      (assign, "$g_presentation_obj_set_skills", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_throwing
      (create_text_overlay, reg0, "str_throwing", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_crossbow
      (create_text_overlay, reg0, "str_crossbow", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_archery
      (create_text_overlay, reg0, "str_archery", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_polearm
      (create_text_overlay, reg0, "str_polearm", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_two_handed_weapon
      (create_text_overlay, reg0, "str_two_handed", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #wpt_one_handed_weapon
      (create_text_overlay, reg0, "str_one_handed", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_herding
      (create_text_overlay, reg0, "str_herding", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_tailoring
      (create_text_overlay, reg0, "str_tailoring", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_sailing
      (create_text_overlay, reg0, "str_sailing", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_looting
      (create_text_overlay, reg0, "str_looting", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_labouring
      (create_text_overlay, reg0, "str_labouring", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_wound_treatment
      (create_text_overlay, reg0, "str_treatment", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_engineer
      (create_text_overlay, reg0, "str_engineer", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_riding
      (create_text_overlay, reg0, "str_riding", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_athletics
      (create_text_overlay, reg0, "str_athletics", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_shield
      (create_text_overlay, reg0, "str_shield", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_power_throw
      (create_text_overlay, reg0, "str_power_throw", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_power_draw
      (create_text_overlay, reg0, "str_power_draw", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_power_strike
      (create_text_overlay, reg0, "str_power_strike", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #skl_ironflesh
      (create_text_overlay, reg0, "str_ironflesh", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #ca_agility
      (create_text_overlay, reg0, "str_agility", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      #ca_strength
      (create_text_overlay, reg0, "str_strength", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_skill_point"),
      (create_text_overlay, reg0, "str_unused_skill_points", 0),
      (assign, "$g_presentation_obj_skill_points", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (create_text_overlay, reg0, "str_skills_menu", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_x, pos1, 130),
      (val_add, ":cur_y", escape_menu_item_height),
      ...
      (assign, reg1, "$player_throwing"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_throwing_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_crossbow"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_crossbow_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_archery"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_archery_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_polearm"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_polearm_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_two_handed"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_two_handed_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_one_handed"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_one_handed_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_herding"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_herding_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_tailoring"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_tailoring_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_sailing"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_sailing_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_looting"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_looting_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_labouring"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_labouring_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_wound_treatment"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_wound_treatment_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_engineer"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_engineer_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_riding"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_riding_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_athletics"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_athletics_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_shield"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_shield_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_power_throw"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_power_throw_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_power_draw"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_power_draw_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_power_strike"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_power_strike_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_ironflesh"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_ironflesh_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_agility"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_agility_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (assign, reg1, "$player_strength"),
      (create_text_overlay, reg0, "str_reg1", 0),
      (assign, "$g_presentation_obj_strength_num", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      ...
      (try_begin),
        #(is_between, ":my_troop_id", hero_begin, hero_end),
        (eq, ":my_troop_id","trp_godlike_hero"),
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 15),
          (lt, "$player_throwing", 80),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_throwing_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 15),
          (lt, "$player_crossbow", 150),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_crossbow_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 15),
          (lt, "$player_archery", 150),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_archery_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 15),
          (lt, "$player_polearm", 130),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_polearm_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 15),
          (lt, "$player_two_handed", 125),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_two_handed_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 15),
          (lt, "$player_one_handed", 115),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_one_handed_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 8),
          (lt, "$player_herding", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_herding_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 8),
          (lt, "$player_tailoring", 3),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_tailoring_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          ...
          (lt, "$player_sailing", 9),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_sailing_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 9),
          (lt, "$player_looting", 6),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_looting_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 10),
          (lt, "$player_labouring", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_labouring_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 11),
          (lt, "$player_wound_treatment", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_wound_treatment_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 12),
          (lt, "$player_engineer", 7),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_engineer_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 13),
          (lt, "$player_riding", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_riding_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_agility", 14),
          (lt, "$player_athletics", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_athletics_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 10),
          (lt, "$player_shield", 2),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_shield_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 11),
          (lt, "$player_power_throw", 3),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_power_throw_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 12),
          (lt, "$player_power_draw", 4),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_power_draw_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 13),
          (lt, "$player_power_strike", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_power_strike_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (ge, "$player_strength", 14),
          (lt, "$player_ironflesh", 5),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_ironflesh_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (lt, "$player_agility", 15),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_agility_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (neq, "$player_skill_point", 0),
          (lt, "$player_strength", 15),
          (create_button_overlay, reg0, "str_add", 0),
          (assign, "$g_presentation_obj_add_strength_num", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
      ...
      (val_add, ":cur_y", escape_menu_item_height),
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_throwing_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_throwing_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_crossbow_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_crossbow_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_archery_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_archery_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_polearm_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_polearm_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_two_handed_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_two_handed_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_one_handed_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_one_handed_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_herding_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_herding_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_tailoring_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_tailoring_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_sailing_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_sailing_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_looting_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_looting_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_labouring_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_labouring_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_wound_treatment_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_wound_treatment_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_engineer_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_engineer_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_riding_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_riding_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_athletics_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_athletics_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_shield_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_shield_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_power_throw_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_power_throw_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_power_draw_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_power_draw_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_power_strike_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_power_strike_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_ironflesh_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_ironflesh_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        #(gt, "$player_agility", 0),
        #(le, "$player_agility", 15),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_agility_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_agility_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (val_add, ":cur_y", escape_menu_item_height),
      (try_begin),
        #(gt, "$player_strength", 0),
        #(le, "$player_strength", 15),
        (create_button_overlay, reg0, "str_sub", 0),
        (assign, "$g_presentation_obj_sub_strength_num", reg0),
        (overlay_set_display, "$g_presentation_obj_sub_strength_num", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (multiplayer_get_my_player, ":my_player_id"),
      (player_get_troop_id, ":player_troop_id", ":my_player_id"),
      (player_get_slot, "$player_used_skill_point", ":my_player_id", slot_player_used_skill_points),

      (try_begin),
        (eq, ":object", "$g_presentation_obj_add_strength_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_attribute, ":player_troop_id", ca_strength, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_attribute_level, ":new_player_strength", ":player_troop_id", ca_strength),
        (le, ":new_player_strength", 15),
        (try_begin),
          (eq, ":new_player_strength", 15),
          (overlay_set_display, "$g_presentation_obj_add_strength_num", 0),
        (try_end),
        (assign, reg1, ":new_player_strength"),
        (overlay_set_text, "$g_presentation_obj_strength_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_strength_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_strength", "$player_strength"),
          (overlay_set_display, "$g_presentation_obj_sub_strength_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_strength_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_attribute, ":player_troop_id", ca_strength, -1),
        (val_sub, "$player_used_skill_point", 1),
        (store_attribute_level, ":new_player_strength", ":player_troop_id", ca_strength),
        (try_begin),
          (lt, ":new_player_strength", 15),
          (overlay_set_display, "$g_presentation_obj_add_strength_num", 1),
        (try_end),
        (ge, ":new_player_strength", "$player_strength"),
        (try_begin),
          (eq, ":new_player_strength", "$player_strength"),
          (assign, reg1, ":new_player_strength"),
          (overlay_set_text, "$g_presentation_obj_strength_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_strength_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_strength_num", 0),
        (else_try),
          (assign, reg1, ":new_player_strength"),
          (overlay_set_text, "$g_presentation_obj_strength_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_agility_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_attribute, ":player_troop_id", ca_agility, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_attribute_level, ":new_player_agility", ":player_troop_id", ca_agility),
        (le, ":new_player_agility", 15),
        (try_begin),
          (eq, ":new_player_agility", 15),
          (overlay_set_display, "$g_presentation_obj_add_agility_num", 0),
        (try_end),
        (assign, reg1, ":new_player_agility"),
        (overlay_set_text, "$g_presentation_obj_agility_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_agility_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_agility", "$player_agility"),
          (overlay_set_display, "$g_presentation_obj_sub_agility_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_agility_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_attribute, ":player_troop_id", ca_agility, -1),
        ...
        (store_attribute_level, ":new_player_agility", ":player_troop_id", ca_agility),
        (try_begin),
          (lt, ":new_player_agility", 15),
          (overlay_set_display, "$g_presentation_obj_add_agility_num", 1),
        (try_end),
        (ge, ":new_player_agility", "$player_agility"),
        (try_begin),
          (eq, ":new_player_agility", "$player_agility"),
          (assign, reg1, ":new_player_agility"),
          (overlay_set_text, "$g_presentation_obj_agility_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_agility_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_agility_num", 0),
        (else_try),
          (assign, reg1, ":new_player_agility"),
          (overlay_set_text, "$g_presentation_obj_agility_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_ironflesh_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_ironflesh, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_ironflesh", skl_ironflesh, ":player_troop_id"),
        (le, ":new_player_ironflesh", 5),
        (try_begin),
          (eq, ":new_player_ironflesh", 5),
          (overlay_set_display, "$g_presentation_obj_add_ironflesh_num", 0),
        (try_end),
        (assign, reg1, ":new_player_ironflesh"),
        (overlay_set_text, "$g_presentation_obj_ironflesh_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_ironflesh_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_ironflesh", "$player_ironflesh"),
          (overlay_set_display, "$g_presentation_obj_sub_ironflesh_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_ironflesh_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_ironflesh, -1),
        ...
        (store_skill_level, ":new_player_ironflesh", skl_ironflesh, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_ironflesh", 5),
          (overlay_set_display, "$g_presentation_obj_add_ironflesh_num", 1),
        (try_end),
        (ge, ":new_player_ironflesh", "$player_ironflesh"),
        (try_begin),
          (eq, ":new_player_ironflesh", "$player_ironflesh"),
          (assign, reg1, ":new_player_ironflesh"),
          (overlay_set_text, "$g_presentation_obj_ironflesh_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_ironflesh_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_ironflesh_num", 0),
        (else_try),
          (assign, reg1, ":new_player_ironflesh"),
          (overlay_set_text, "$g_presentation_obj_ironflesh_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_power_strike_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_strike, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_power_strike", skl_power_strike, ":player_troop_id"),
        (le, ":new_player_power_strike", 4),
        (try_begin),
          (eq, ":new_player_power_strike", 4),
          (overlay_set_display, "$g_presentation_obj_add_power_strike_num", 0),
        (try_end),
        (assign, reg1, ":new_player_power_strike"),
        (overlay_set_text, "$g_presentation_obj_power_strike_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_power_strike_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_power_strike", "$player_power_strike"),
          (overlay_set_display, "$g_presentation_obj_sub_power_strike_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_power_strike_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_strike, -1),
        ...
        (store_skill_level, ":new_player_power_strike", skl_power_strike, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_power_strike", 4),
          (overlay_set_display, "$g_presentation_obj_add_power_strike_num", 1),
        (try_end),
        (ge, ":new_player_power_strike", "$player_power_strike"),
        (try_begin),
          (eq, ":new_player_power_strike", "$player_power_strike"),
          (assign, reg1, ":new_player_power_strike"),
          (overlay_set_text, "$g_presentation_obj_power_strike_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_power_strike_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_power_strike_num", 0),
        (else_try),
          (assign, reg1, ":new_player_power_strike"),
          (overlay_set_text, "$g_presentation_obj_power_strike_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_power_draw_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_draw, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_power_draw", skl_power_draw, ":player_troop_id"),
        (le, ":new_player_power_draw", 4),
        (try_begin),
          (eq, ":new_player_power_draw", 4),
          (overlay_set_display, "$g_presentation_obj_add_power_draw_num", 0),
        (try_end),
        (assign, reg1, ":new_player_power_draw"),
        (overlay_set_text, "$g_presentation_obj_power_draw_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_power_draw_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_power_draw", "$player_power_draw"),
          (overlay_set_display, "$g_presentation_obj_sub_power_draw_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_power_draw_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_draw, -1),
        ...
        (store_skill_level, ":new_player_power_draw", skl_power_draw, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_power_draw", 4),
          (overlay_set_display, "$g_presentation_obj_add_power_draw_num", 1),
        (try_end),
        (ge, ":new_player_power_draw", "$player_power_draw"),
        (try_begin),
          (eq, ":new_player_power_draw", "$player_power_draw"),
          (assign, reg1, ":new_player_power_draw"),
          (overlay_set_text, "$g_presentation_obj_power_draw_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_power_draw_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_power_draw_num", 0),
        (else_try),
          (assign, reg1, ":new_player_power_draw"),
          (overlay_set_text, "$g_presentation_obj_power_draw_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_power_throw_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_throw, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_power_throw", skl_power_throw, ":player_troop_id"),
        (le, ":new_player_power_throw", 3),
        (try_begin),
          (eq, ":new_player_power_throw", 3),
          (overlay_set_display, "$g_presentation_obj_add_power_throw_num", 0),
        (try_end),
        (assign, reg1, ":new_player_power_throw"),
        (overlay_set_text, "$g_presentation_obj_power_throw_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_power_throw_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_power_throw", "$player_power_throw"),
          (overlay_set_display, "$g_presentation_obj_sub_power_throw_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_power_throw_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_power_throw, -1),
        ...
        (store_skill_level, ":new_player_power_throw", skl_power_throw, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_power_throw", 3),
          (overlay_set_display, "$g_presentation_obj_add_power_throw_num", 1),
        (try_end),
        (ge, ":new_player_power_throw", "$player_power_throw"),
        (try_begin),
          (eq, ":new_player_power_throw", "$player_power_throw"),
          (assign, reg1, ":new_player_power_throw"),
          (overlay_set_text, "$g_presentation_obj_power_throw_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_power_throw_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_power_throw_num", 0),
        (else_try),
          (assign, reg1, ":new_player_power_throw"),
          (overlay_set_text, "$g_presentation_obj_power_throw_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_shield_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_shield, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_shield", skl_shield, ":player_troop_id"),
        (le, ":new_player_shield", 2),
        (try_begin),
          (eq, ":new_player_shield", 2),
          (overlay_set_display, "$g_presentation_obj_add_shield_num", 0),
        (try_end),
        (assign, reg1, ":new_player_shield"),
        (overlay_set_text, "$g_presentation_obj_shield_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_shield_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_shield", "$player_shield"),
          (overlay_set_display, "$g_presentation_obj_sub_shield_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_shield_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_shield, -1),
        ...
        (store_skill_level, ":new_player_shield", skl_shield, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_shield", 2),
          (overlay_set_display, "$g_presentation_obj_add_shield_num", 1),
        (try_end),
        (ge, ":new_player_shield", "$player_shield"),
        (try_begin),
          (eq, ":new_player_shield", "$player_shield"),
          (assign, reg1, ":new_player_shield"),
          (overlay_set_text, "$g_presentation_obj_shield_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_shield_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_shield_num", 0),
        (else_try),
          (assign, reg1, ":new_player_shield"),
          (overlay_set_text, "$g_presentation_obj_shield_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_athletics_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_athletics, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_athletics", skl_athletics, ":player_troop_id"),
        (le, ":new_player_athletics", 5),
        (try_begin),
          (eq, ":new_player_athletics", 5),
          (overlay_set_display, "$g_presentation_obj_add_athletics_num", 0),
        (try_end),
        (assign, reg1, ":new_player_athletics"),
        (overlay_set_text, "$g_presentation_obj_athletics_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_athletics_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_athletics", "$player_athletics"),
          (overlay_set_display, "$g_presentation_obj_sub_athletics_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_athletics_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_athletics, -1),
        ...
        (store_skill_level, ":new_player_athletics", skl_athletics, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_athletics", 5),
          (overlay_set_display, "$g_presentation_obj_add_athletics_num", 1),
        (try_end),
        (ge, ":new_player_athletics", "$player_athletics"),
        (try_begin),
          (eq, ":new_player_athletics", "$player_athletics"),
          (assign, reg1, ":new_player_athletics"),
          (overlay_set_text, "$g_presentation_obj_athletics_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_athletics_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_athletics_num", 0),
        (else_try),
          (assign, reg1, ":new_player_athletics"),
          (overlay_set_text, "$g_presentation_obj_athletics_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_riding_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_riding, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_riding", skl_riding, ":player_troop_id"),
        (le, ":new_player_riding", 5),
        (try_begin),
          (eq, ":new_player_riding", 5),
          (overlay_set_display, "$g_presentation_obj_add_riding_num", 0),
        (try_end),
        (assign, reg1, ":new_player_riding"),
        (overlay_set_text, "$g_presentation_obj_riding_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_riding_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_riding", "$player_riding"),
          (overlay_set_display, "$g_presentation_obj_sub_riding_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_riding_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_riding, -1),
        ...
        (store_skill_level, ":new_player_riding", skl_riding, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_riding", 5),
          (overlay_set_display, "$g_presentation_obj_add_riding_num", 1),
        (try_end),
        (ge, ":new_player_riding", "$player_riding"),
        (try_begin),
          (eq, ":new_player_riding", "$player_riding"),
          (assign, reg1, ":new_player_riding"),
          (overlay_set_text, "$g_presentation_obj_riding_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_riding_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_riding_num", 0),
        (else_try),
          (assign, reg1, ":new_player_riding"),
          (overlay_set_text, "$g_presentation_obj_riding_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_engineer_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_engineer, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_engineer", skl_engineer, ":player_troop_id"),
        (le, ":new_player_engineer", 7),
        (try_begin),
          (eq, ":new_player_engineer", 7),
          (overlay_set_display, "$g_presentation_obj_add_engineer_num", 0),
        (try_end),
        (assign, reg1, ":new_player_engineer"),
        (overlay_set_text, "$g_presentation_obj_engineer_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_engineer_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_engineer", "$player_engineer"),
          (overlay_set_display, "$g_presentation_obj_sub_engineer_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_engineer_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_engineer, -1),
        ...
        (store_skill_level, ":new_player_engineer", skl_engineer, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_engineer", 7),
          (overlay_set_display, "$g_presentation_obj_add_engineer_num", 1),
        (try_end),
        (ge, ":new_player_engineer", "$player_engineer"),
        (try_begin),
          (eq, ":new_player_engineer", "$player_engineer"),
          (assign, reg1, ":new_player_engineer"),
          (overlay_set_text, "$g_presentation_obj_engineer_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_engineer_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_engineer_num", 0),
        (else_try),
          (assign, reg1, ":new_player_engineer"),
          (overlay_set_text, "$g_presentation_obj_engineer_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_wound_treatment_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_wound_treatment, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_wound_treatment", skl_wound_treatment, ":player_troop_id"),
        (le, ":new_player_wound_treatment", 5),
        (try_begin),
          (eq, ":new_player_wound_treatment", 5),
          (overlay_set_display, "$g_presentation_obj_add_wound_treatment_num", 0),
        (try_end),
        (assign, reg1, ":new_player_wound_treatment"),
        (overlay_set_text, "$g_presentation_obj_wound_treatment_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_wound_treatment_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_wound_treatment", "$player_wound_treatment"),
          (overlay_set_display, "$g_presentation_obj_sub_wound_treatment_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_wound_treatment_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_wound_treatment, -1),
        ...
        (store_skill_level, ":new_player_wound_treatment", skl_wound_treatment, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_wound_treatment", 5),
          (overlay_set_display, "$g_presentation_obj_add_wound_treatment_num", 1),
        (try_end),
        (ge, ":new_player_wound_treatment", "$player_wound_treatment"),
        (try_begin),
          (eq, ":new_player_wound_treatment", "$player_wound_treatment"),
          (assign, reg1, ":new_player_wound_treatment"),
          (overlay_set_text, "$g_presentation_obj_wound_treatment_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_wound_treatment_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_wound_treatment_num", 0),
        (else_try),
          (assign, reg1, ":new_player_wound_treatment"),
          (overlay_set_text, "$g_presentation_obj_wound_treatment_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_labouring_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_labouring, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_labouring", skl_labouring, ":player_troop_id"),
        (le, ":new_player_labouring", 5),
        (try_begin),
          (eq, ":new_player_labouring", 5),
          (overlay_set_display, "$g_presentation_obj_add_labouring_num", 0),
        (try_end),
        (assign, reg1, ":new_player_labouring"),
        (overlay_set_text, "$g_presentation_obj_labouring_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_labouring_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_labouring", "$player_labouring"),
          (overlay_set_display, "$g_presentation_obj_sub_labouring_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_labouring_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_labouring, -1),
        ...
        (store_skill_level, ":new_player_labouring", skl_labouring, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_labouring", 5),
          (overlay_set_display, "$g_presentation_obj_add_labouring_num", 1),
        (try_end),
        (ge, ":new_player_labouring", "$player_labouring"),
        (try_begin),
          (eq, ":new_player_labouring", "$player_labouring"),
          (assign, reg1, ":new_player_labouring"),
          (overlay_set_text, "$g_presentation_obj_labouring_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_labouring_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_labouring_num", 0),
        (else_try),
          (assign, reg1, ":new_player_labouring"),
          (overlay_set_text, "$g_presentation_obj_labouring_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_looting_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_looting, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_looting", skl_looting, ":player_troop_id"),
        (le, ":new_player_looting", 6),
        (try_begin),
          (eq, ":new_player_looting", 6),
          (overlay_set_display, "$g_presentation_obj_add_looting_num", 0),
        (try_end),
        (assign, reg1, ":new_player_looting"),
        (overlay_set_text, "$g_presentation_obj_looting_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_looting_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_looting", "$player_looting"),
          (overlay_set_display, "$g_presentation_obj_sub_looting_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_looting_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_looting, -1),
        ...
        (store_skill_level, ":new_player_looting", skl_looting, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_looting", 6),
          (overlay_set_display, "$g_presentation_obj_add_looting_num", 1),
        (try_end),
        (ge, ":new_player_looting", "$player_looting"),
        (try_begin),
          (eq, ":new_player_looting", "$player_looting"),
          (assign, reg1, ":new_player_looting"),
          (overlay_set_text, "$g_presentation_obj_looting_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_looting_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_looting_num", 0),
        (else_try),
          (assign, reg1, ":new_player_looting"),
          (overlay_set_text, "$g_presentation_obj_looting_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_sailing_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_sailing, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_sailing", skl_sailing, ":player_troop_id"),
        (le, ":new_player_sailing", 9),
        (try_begin),
          (eq, ":new_player_sailing", 9),
          (overlay_set_display, "$g_presentation_obj_add_sailing_num", 0),
        (try_end),
        (assign, reg1, ":new_player_sailing"),
        (overlay_set_text, "$g_presentation_obj_sailing_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_sailing_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_sailing", "$player_sailing"),
          (overlay_set_display, "$g_presentation_obj_sub_sailing_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_sailing_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_sailing, -1),
        ...
        (store_skill_level, ":new_player_sailing", skl_sailing, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_sailing", 9),
          (overlay_set_display, "$g_presentation_obj_add_sailing_num", 1),
        (try_end),
        (ge, ":new_player_sailing", "$player_sailing"),
        (try_begin),
          (eq, ":new_player_sailing", "$player_sailing"),
          (assign, reg1, ":new_player_sailing"),
          (overlay_set_text, "$g_presentation_obj_sailing_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_sailing_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_sailing_num", 0),
        (else_try),
          (assign, reg1, ":new_player_sailing"),
          (overlay_set_text, "$g_presentation_obj_sailing_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_tailoring_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_tailoring, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_tailoring", skl_tailoring, ":player_troop_id"),
        (le, ":new_player_tailoring", 3),
        (try_begin),
          (eq, ":new_player_tailoring", 3),
          (overlay_set_display, "$g_presentation_obj_add_tailoring_num", 0),
        (try_end),
        (assign, reg1, ":new_player_tailoring"),
        (overlay_set_text, "$g_presentation_obj_tailoring_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_tailoring_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_tailoring", "$player_tailoring"),
          (overlay_set_display, "$g_presentation_obj_sub_tailoring_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_tailoring_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_tailoring, -1),
        ...
        (store_skill_level, ":new_player_tailoring", skl_tailoring, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_tailoring", 3),
          (overlay_set_display, "$g_presentation_obj_add_tailoring_num", 1),
        (try_end),
        (ge, ":new_player_tailoring", "$player_tailoring"),
        (try_begin),
          (eq, ":new_player_tailoring", "$player_tailoring"),
          (assign, reg1, ":new_player_tailoring"),
          (overlay_set_text, "$g_presentation_obj_tailoring_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_tailoring_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_tailoring_num", 0),
        (else_try),
          (assign, reg1, ":new_player_tailoring"),
          (overlay_set_text, "$g_presentation_obj_tailoring_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_herding_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_herding, 1),
        (val_add, "$player_used_skill_point", 1),
        (store_skill_level, ":new_player_herding", skl_herding, ":player_troop_id"),
        (le, ":new_player_herding", 5),
        (try_begin),
          (eq, ":new_player_herding", 5),
          (overlay_set_display, "$g_presentation_obj_add_herding_num", 0),
        (try_end),
        (assign, reg1, ":new_player_herding"),
        (overlay_set_text, "$g_presentation_obj_herding_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_herding_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_herding", "$player_herding"),
          (overlay_set_display, "$g_presentation_obj_sub_herding_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_herding_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_skill, ":player_troop_id", skl_herding, -1),
        ...
        (store_skill_level, ":new_player_herding", skl_herding, ":player_troop_id"),
        (try_begin),
          (lt, ":new_player_herding", 5),
          (overlay_set_display, "$g_presentation_obj_add_herding_num", 1),
        (try_end),
        (ge, ":new_player_herding", "$player_herding"),
        (try_begin),
          (eq, ":new_player_herding", "$player_herding"),
          (assign, reg1, ":new_player_herding"),
          (overlay_set_text, "$g_presentation_obj_herding_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_herding_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_herding_num", 0),
        (else_try),
          (assign, reg1, ":new_player_herding"),
          (overlay_set_text, "$g_presentation_obj_herding_num", "str_reg1"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_one_handed_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_one_handed_weapon, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_one_handed", ":player_troop_id", wpt_one_handed_weapon), 
        (le, ":new_player_one_handed", 115),
        (try_begin),
          (eq, ":new_player_one_handed", 115),
          (overlay_set_display, "$g_presentation_obj_add_one_handed_num", 0),
        (try_end),
        (assign, reg1, ":new_player_one_handed"),
        (overlay_set_text, "$g_presentation_obj_one_handed_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_one_handed_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_one_handed", "$player_one_handed"),
          (overlay_set_display, "$g_presentation_obj_sub_one_handed_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_one_handed_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_one_handed_weapon, -10),
        ...
        (store_proficiency_level, ":new_player_one_handed", ":player_troop_id", wpt_one_handed_weapon), 
        (try_begin),
          (lt, ":new_player_one_handed", 115),
          (overlay_set_display, "$g_presentation_obj_sub_one_handed_num", 1),
        (try_end),
        (ge, ":new_player_one_handed", "$player_one_handed"),
        (try_begin),
          (eq, ":new_player_one_handed", "$player_one_handed"),
          (assign, reg1, ":new_player_one_handed"),
          (overlay_set_text, "$g_presentation_obj_one_handed_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_one_handed_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_one_handed_num", 0),
        (else_try),
          (assign, reg1, ":new_player_one_handed"),
          (overlay_set_text, "$g_presentation_obj_one_handed_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_two_handed_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_two_handed_weapon, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_two_handed", ":player_troop_id", wpt_two_handed_weapon),  
        (le, ":new_player_two_handed", 125),
        (try_begin),
          (eq, ":new_player_two_handed", 125),
          (overlay_set_display, "$g_presentation_obj_add_two_handed_num", 0),
        (try_end),
        (assign, reg1, ":new_player_two_handed"),
        (overlay_set_text, "$g_presentation_obj_two_handed_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_two_handed_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_two_handed", "$player_two_handed"),
          (overlay_set_display, "$g_presentation_obj_sub_two_handed_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_two_handed_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_two_handed_weapon, -10),
        ...
        (store_proficiency_level, ":new_player_two_handed", ":player_troop_id", wpt_two_handed_weapon), 
        (try_begin),
          (lt, ":new_player_two_handed", 125),
          (overlay_set_display, "$g_presentation_obj_sub_two_handed_num", 1),
        (try_end),
        (ge, ":new_player_two_handed", "$player_two_handed"),
        (try_begin),
          (eq, ":new_player_two_handed", "$player_two_handed"),
          (assign, reg1, ":new_player_two_handed"),
          (overlay_set_text, "$g_presentation_obj_two_handed_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_two_handed_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_two_handed_num", 0),
        (else_try),
          (assign, reg1, ":new_player_two_handed"),
          (overlay_set_text, "$g_presentation_obj_two_handed_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_polearm_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_polearm, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_polearm", ":player_troop_id", wpt_polearm),  
        (le, ":new_player_polearm", 130),
        (try_begin),
          (eq, ":new_player_polearm", 130),
          (overlay_set_display, "$g_presentation_obj_add_polearm_num", 0),
        (try_end),
        (assign, reg1, ":new_player_polearm"),
        (overlay_set_text, "$g_presentation_obj_polearm_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_polearm_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_polearm", "$player_polearm"),
          (overlay_set_display, "$g_presentation_obj_sub_polearm_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_polearm_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_polearm, -10),
        ...
        (store_proficiency_level, ":new_player_polearm", ":player_troop_id", wpt_polearm), 
        (try_begin),
          (lt, ":new_player_polearm", 130),
          (overlay_set_display, "$g_presentation_obj_sub_polearm_num", 1),
        (try_end),
        (ge, ":new_player_polearm", "$player_polearm"),
        (try_begin),
          (eq, ":new_player_polearm", "$player_polearm"),
          (assign, reg1, ":new_player_polearm"),
          (overlay_set_text, "$g_presentation_obj_polearm_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_polearm_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_polearm_num", 0),
        (else_try),
          (assign, reg1, ":new_player_polearm"),
          (overlay_set_text, "$g_presentation_obj_polearm_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_archery_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_archery, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_archery", ":player_troop_id", wpt_archery),  
        (le, ":new_player_archery", 150),
        (try_begin),
          (eq, ":new_player_archery", 150),
          (overlay_set_display, "$g_presentation_obj_add_archery_num", 0),
        (try_end),
        (assign, reg1, ":new_player_archery"),
        (overlay_set_text, "$g_presentation_obj_archery_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_archery_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_archery", "$player_archery"),
          (overlay_set_display, "$g_presentation_obj_sub_archery_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_archery_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_archery, -10),
        ...
        (store_proficiency_level, ":new_player_archery", ":player_troop_id", wpt_archery), 
        (try_begin),
          (lt, ":new_player_archery", 150),
          (overlay_set_display, "$g_presentation_obj_sub_archery_num", 1),
        (try_end),
        (ge, ":new_player_archery", "$player_archery"),
        (try_begin),
          (eq, ":new_player_archery", "$player_archery"),
          (assign, reg1, ":new_player_archery"),
          (overlay_set_text, "$g_presentation_obj_archery_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_archery_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_archery_num", 0),
        (else_try),
          (assign, reg1, ":new_player_archery"),
          (overlay_set_text, "$g_presentation_obj_archery_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_crossbow_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_crossbow, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_crossbow", ":player_troop_id", wpt_crossbow),  
        (le, ":new_player_crossbow", 150),
        (try_begin),
          (eq, ":new_player_crossbow", 150),
          (overlay_set_display, "$g_presentation_obj_add_crossbow_num", 0),
        (try_end),
        (assign, reg1, ":new_player_crossbow"),
        (overlay_set_text, "$g_presentation_obj_crossbow_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_crossbow_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_crossbow", "$player_crossbow"),
          (overlay_set_display, "$g_presentation_obj_sub_crossbow_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_crossbow_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_crossbow, -10),
        ...
        (store_proficiency_level, ":new_player_crossbow", ":player_troop_id", wpt_crossbow), 
        (try_begin),
          (lt, ":new_player_crossbow", 150),
          (overlay_set_display, "$g_presentation_obj_sub_crossbow_num", 1),
        (try_end),
        (ge, ":new_player_crossbow", "$player_crossbow"),
        (try_begin),
          (eq, ":new_player_crossbow", "$player_crossbow"),
          (assign, reg1, ":new_player_crossbow"),
          (overlay_set_text, "$g_presentation_obj_crossbow_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_crossbow_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_crossbow_num", 0),
        (else_try),
          (assign, reg1, ":new_player_crossbow"),
          (overlay_set_text, "$g_presentation_obj_crossbow_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_add_throwing_num"),
        (ge, "$player_skill_point", 1),
        (val_sub, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_throwing, 10),
        (val_add, "$player_used_skill_point", 1),
        (store_proficiency_level, ":new_player_throwing", ":player_troop_id", wpt_throwing), 
        (le, ":new_player_throwing", 80),
        (try_begin),
          (eq, ":new_player_crossbow", 80),
          (overlay_set_display, "$g_presentation_obj_add_throwing_num", 0),
        (try_end),
        (assign, reg1, ":new_player_throwing"),
        (overlay_set_text, "$g_presentation_obj_throwing_num", "str_reg1"),
        (overlay_set_color, "$g_presentation_obj_throwing_num", 0xFF3333),
        (try_begin),
          (gt, ":new_player_throwing", "$player_throwing"),
          (overlay_set_display, "$g_presentation_obj_sub_throwing_num", 1),
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_sub_throwing_num"),
        (val_add, "$player_skill_point", 1),
        (assign, reg1, "$player_skill_point"),
        (overlay_set_text, "$g_presentation_obj_skill_points", "str_unused_skill_points"),
        (troop_raise_proficiency_linear, ":player_troop_id", wpt_throwing, -10),
        ...
        (store_proficiency_level, ":new_player_throwing", ":player_troop_id", wpt_throwing),
        (try_begin),
          (lt, ":new_player_throwing", 80),
          (overlay_set_display, "$g_presentation_obj_add_throwing_num", 1),
        (try_end),
        (ge, ":new_player_throwing", "$player_throwing"),
        (try_begin),
          (eq, ":new_player_throwing", "$player_throwing"),
          (assign, reg1, ":new_player_throwing"),
          (overlay_set_text, "$g_presentation_obj_throwing_num", "str_reg1"),
          (overlay_set_color, "$g_presentation_obj_throwing_num", 0xFFFFFF),
          (overlay_set_display, "$g_presentation_obj_sub_throwing_num", 0),
        (else_try),
          (assign, reg1, ":new_player_throwing"),
          (overlay_set_text, "$g_presentation_obj_throwing_num", "str_reg1"),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_set_skills"),
        #(is_between, ":my_troop_id", hero_begin, hero_end),
        (eq, ":player_troop_id", "trp_godlike_hero"),

        (store_attribute_level, ":strength", ":player_troop_id", ca_strength),
        (store_attribute_level, ":agility", ":player_troop_id", ca_agility),
        (store_skill_level, ":ironflesh", skl_ironflesh, ":player_troop_id"),
        (store_skill_level, ":power_strike", skl_power_strike, ":player_troop_id"),
        (store_skill_level, ":power_draw", skl_power_draw, ":player_troop_id"),
        (store_skill_level, ":power_throw", skl_power_throw, ":player_troop_id"),
        (store_skill_level, ":shield", skl_shield, ":player_troop_id"),
        (store_skill_level, ":athletics", skl_athletics, ":player_troop_id"),
        (store_skill_level, ":riding", skl_riding, ":player_troop_id"),
        (store_skill_level, ":engineer", skl_engineer, ":player_troop_id"),
        (store_skill_level, ":wound_treatment", skl_wound_treatment, ":player_troop_id"),
        (store_skill_level, ":labouring", skl_labouring, ":player_troop_id"),
        (store_skill_level, ":looting", skl_looting, ":player_troop_id"),
        (store_skill_level, ":sailing", skl_sailing, ":player_troop_id"),
        (store_skill_level, ":tailoring", skl_tailoring, ":player_troop_id"),
        (store_skill_level, ":herding", skl_herding, ":player_troop_id"),
        (store_proficiency_level, ":one_handed", ":player_troop_id", wpt_one_handed_weapon),
        (store_proficiency_level, ":two_handed", ":player_troop_id", wpt_two_handed_weapon),
        (store_proficiency_level, ":polearm", ":player_troop_id", wpt_polearm),
        (store_proficiency_level, ":archery", ":player_troop_id", wpt_archery),
        (store_proficiency_level, ":crossbow", ":player_troop_id", wpt_crossbow),
        (store_proficiency_level, ":throwing", ":player_troop_id", wpt_throwing), 

        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_strength, ":strength"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_agility, ":agility"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_ironflesh, ":ironflesh"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_power_strike, ":power_strike"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_power_draw, ":power_draw"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_power_throw, ":power_throw"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_shield, ":shield"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_athletics, ":athletics"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_riding, ":riding"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_engineer, ":engineer"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_wound_treatment, ":wound_treatment"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_labouring, ":labouring"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_looting, ":looting"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_sailing, ":sailing"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_tailoring, ":tailoring"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_herding, ":herding"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_one_handed_weapon, ":one_handed"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_two_handed_weapon, ":two_handed"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_polearm, ":polearm"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_archery, ":archery"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_crossbow, ":crossbow"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_troop_throwing, ":throwing"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_unused_skill_points, "$player_skill_point"),
        (multiplayer_send_3_int_to_server, client_event_player_set_slot, ":my_player_id", slot_player_used_skill_points, "$player_used_skill_point"),
        (presentation_set_duration, 0),
      (try_end),
      ]),
