...
"),
  ...
  #GGG:admin tools
  ("add_outlaw_player", "Add outlaw rating to a player"),
  ("sub_outlaw_player", "Sub outlaw rating to a player"),
  ("teleport_player_to_admin", "Teleport a player to admin"),
  #
  ...
  #GGG:admin tools
  ("remove_wild_animals", "Remove wild animals"),
  ("remove_corpses", "Remove corpses"),
  ("remove_all_weapons", "Remove all weapons"),
  ("reset_carts", "Reset all carts"),
  #
  ...
  ("lock_faction_capture", "Lock Faction Capture"),   #GGG:admin tools
  ("quit", "Quit"),
  ...
  #GGG:admin tool
  ("log_admin_add_outlaw_player", "add outlaw"),
  ("log_admin_sub_outlaw_player", "sub outlaw"),
  ("log_admin_teleport_player_to_admin", "drag"),
  #
  ...
  #GGG:admin tool
  ("log_admin_remove_wild_animals", "removed wild_animals"),
  ("log_admin_remove_corpses", "remove corpses"),
  ("log_admin_remove_all_weapons", "remove all weapons"),
  ("log_admin_reset_carts", "reset carts"),
  #
  ...
  ("log_admin_lock_faction_capture", "{s4} locked faction {s5} capture"),
  ...
  ("zero", "0"),
  ("downline_in_reg0_seconds", "You will downline in {reg0} seconds, please don't touch any key."), #GGG:delay downline
  ...
  ("faction_military_strength_is_reg1", "faction military strength is {reg3}"),  #GGG:troop system
  ...
  ("marquis", "Marquis"),
  ("duke", "Duke"),
  ("knight_master", "KnightMaster"),
  ("iron_bank", "IronBank"),
  ("protector_of_the_realm", "ProtectorOfTheRealm"),
  ("king_of_eight_kingdom", "KingOfEightKingdom"),
  ("city_guard", "CityGuard"),
  ("boss_of_bar", "BossOfBar"),
  ("minstrel", "Minstrel"),
  ("grand_scholar", "GrandScholar"),
  ("archbishop", "Archbishop"),
  ("banker", "Banker"),
  ("capitalist", "Capitalist"),
  ("weapons_master", "WeaponsMaster"),
  ("armour_master", "ArmourMaster"),
  ("golden_regiment", "GoldenRegiment"),
  ("second_sons", "SecondSons"),
  ("sword_of_morning", "SwordOfMorning"),
  ("horse_king", "HorseKing"),
  ("no_banners_man", "NoBannersMan"),
  ("hand_of_king", "HandOfKing"),
  ("green_prophet", "GreenProphet"),
  ("hound", "Hound"),
  ("mountain", "Mountain"),
  ("family_leader", "FamilyLeader"),
  ("kingsguard", "Kingsguard"),
  ("khal", "Khal"),
  ("greenwood_man", "GreenwoodMan"),
  ("rainbow_tailor", "RainbowTailor"),
  ("breaker_of_chains", "BreakerOfChains"),
  ("knight_of_flowers", "KnightOfFlowers"),
  ("kingslayer", "KingSlayer"),
  ("red_serpent", "RedSerpent"),
  ("no_one", "NoOne"),
  ("black_knight", "BlackKnight"),
  ("hatamotosamurai", "Hatamoto Samurai"),
  #GGG:outlaw rating
  ("outlaw_rating", "Outlaw Rating"),
  #
  ("class", "Class"),
  ("kills", "Kills"),
  ("deaths", "Deaths"),
  ...
  ("toggle_helmet", "open / close helmet"), #GGG:open helmet
  ...
  ###GGG:skills menu
  #("buy_skill_point", "Buy a skill point (100000 dnr)"),
  #("reset_skill_point", "Reset all the skill point (450000 dnr)"),
  #
  ...
  #GGG:smithing system
  ("process_smithing", "Forge weapons or armor"),
  #GGG:skin system
...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  #GGG:new
  ("take_a_seat", "Sit"),
  ("clean_your_sin", "Cost 5000 dnr to clean 1 point of outlaw rating"),
  ("you_were_arrested", "You were arrested."),
  ("you_arrested_s1", "You arrested {s1}."),
  ("item_materials_s1", "materials : {s1}"),
  ("lock_capture", "{s0} (lock)"),
  ("unlock_capture", "{s0} (unlock)"),
  #GGG:skill name
  ("skills_menu", "Skills Menu"),
  ("unused_skill_points", "Unused Skill Points: {reg1}"),
  ("strength", "Strength"),
  ("agility", "Agility"),
  ("ironflesh", "Ironflesh"),
  ...
  ###GGG:new bank
  ("no_number_entered_error", "You don't seem to have entered a number. Please, enter a number, then retry."),
  ("cannot_deposit_too_little_gold", "Cannot deposit {reg2} gold. You only seem to be carrying {reg3} gold. "),
  ("cannot_withdraw_too_little_gold", "Cannot withdraw {reg2} gold. You only seem to have {reg3} gold in your bank account."),
  ("cannot_deposit_negative_amount", "Cannot deposit {reg2} gold. You cannot deposit a negative amount of gold."),
  ("cannot_withdraw_negative_amount", "Cannot withdraw {reg2} gold. You cannot withdraw a negative amount of gold."),  
  #
  
  #GGG:get materials
  ("itm_stick","itm_stick"),
  ("itm_stick_melee","itm_stick_melee"),
  ("itm_branch","itm_branch"),
  ("itm_wood_pole_short","itm_wood_pole_short"),
  ("itm_wood_pole","itm_wood_pole"),
  ("itm_wood_block","itm_wood_block"),
  ("itm_board","itm_board"),
  ("itm_iron_ore_small","itm_iron_ore_small"),
  ("itm_iron_ore","itm_iron_ore"),
  ("itm_iron_piece","itm_iron_piece"),
  ("itm_iron_bar_short","itm_iron_bar_short"),
  ("itm_iron_bar","itm_iron_bar"),
  ("itm_iron_bar_long","itm_iron_bar_long"),
  ("itm_gold_nugget","itm_gold_nugget"),
  ("itm_gold_bar","itm_gold_bar"),
  ("itm_silver_nugget","itm_silver_nugget"),
  ("itm_silver_bar","itm_silver_bar"),
  ("itm_flax_bundle","itm_flax_bundle"),
  ("itm_linen_thread","itm_linen_thread"),
  ("itm_linen_cloth","itm_linen_cloth"),
  ("itm_linen_cloth_small","itm_linen_cloth_small"),
  ("itm_raw_hide","itm_raw_hide"),
  ("itm_leather_roll","itm_leather_roll"),
  ("itm_leather_piece","itm_leather_piece"),
  ("itm_saddle","itm_saddle"),
  ("itm_wheat_sheaf","itm_wheat_sheaf"),
  ("itm_grapes","itm_grapes"),
  ("itm_raw_meat","itm_raw_meat"),
  ("itm_horse_armor","itm_horse_armor"),
  ("itm_dagger","itm_dagger"),
  ("itm_poison_herb","itm_poison_herb"),
  ("itm_healing_herb","itm_healing_herb"),

  #GGG:music menu
  ("music_menu","Music Menu"),
  ("bgm_victory","Two Steps From Hell - Victory"),
  ("bgm_world","The World is Ahead"),
  ("bgm_lankhmar","Audio machine - Lords of Lankhmar"),
  ("bgm_away","The Soil Bleeds Black - Away"),
  ("bgm_ezio","Jesper Kyd - Ezio's Family"),
  ("bgm_warrior","Sean Householder - The Warrior Song"),

  #GGG:knights
  ("knights_1","Strawhat Knights"),
  ("api_address", "http://api.persistentworld.cn/server/"),
