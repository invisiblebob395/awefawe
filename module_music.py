...
tracks = [
 ...
 ("bgm_victory", "bgm_Victory.mp3", mtf_module_track, 0),
 ("bgm_world", "bgm_World.mp3", mtf_module_track, 0),
 ("bgm_lankhmar", "bgm_Lankhmar.mp3", mtf_module_track, 0),
 ("bgm_away", "bgm_Away.mp3", mtf_module_track, 0),
 ("bgm_ezio", "bgm_Ezio.mp3", mtf_module_track, 0),
 ("bgm_warrior", "bgm_Warrior.mp3", mtf_module_track, 0),
]
