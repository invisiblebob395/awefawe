...
slot_player_god_of_eye = 74
slot_player_no_global_chat = 75
slot_player_spawn_water_amount = 76

###GGG:new bank
slot_player_must_enter_amount = 77
slot_player_gold_give_back = 78
###
slot_player_buy_bot = 79
########################################################
##  AGENT SLOTS            #############################
########################################################
...
scripted_items_begin = "itm_light_lance" #ggg:itm_surgeon_scalpel # items outside this range are not checked from the ti_on_agent_hit trigger
